#!/usr/bin/env python
"""
Script to fix the agent.py file for the full agentic RAG system.
"""
import os
import sys
import shutil
...
def fix_agent_file():
    """Fix the agent.py file for the full agentic RAG system."""
    print(f"Fixing agent.py file at {AGENT_FILE_PATH}")
    
    # Create a backup of the original file
    backup_path = AGENT_FILE_PATH + ".backup"
    shutil.copy2(AGENT_FILE_PATH, backup_path)
    print(f"Created backup at {backup_path}")
    
    # Create the new agent.py file with fixed syntax
...
""")
    ...
    print("Fixed agent.py file successfully")
